...
function tplOrderShipped({ customerName = "Customer", orderId = "#KL-0000", trackingNumber = "", courierName = "Delhivery", estimatedDelivery = "" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-blue">🚚 Order Shipped</span>
...
function tplOrderCancelled({ customerName = "Customer", orderId = "#KL-0000", reason = "", refundAmount = 0 } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-red">❌ Order Cancelled</span>
    <p class="greeting">Namaste ${customerName},</p>
...
function tplRefundProcessed({ customerName = "Customer", orderId = "#KL-0000", refundAmount = 0, refundMethod = "original payment method" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-green">💚 Refund Processed</span>
    <p class="greeting">Namaste ${customerName} 🙏</p>
...
function tplReturnReceived({ customerName = "Customer", orderId = "#KL-0000", returnId = "" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-amber">↩️ Return Request Received</span>
    <p class="greeting">Namaste ${customerName} 🙏</p>
...
function tplWelcomeEmail({ customerName = "Customer" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-amber">🙏 Welcome to Kalavritti!</span>
    <p class="greeting">Namaste ${customerName}!</p>
    ...
    <div class="info-box">
      ...
      🏺 <strong>100% Authentic Handmade</strong> — Every product is crafted by skilled artisans<br />
      🌿 <strong>Direct from Artisans</strong> — Your purchase directly supports the maker<br />
      🛡️ <strong>Quality Guaranteed</strong> — Curated for quality, authenticity, and fair trade<br />
      📦 <strong>Secure Delivery</strong> — Carefully packaged to preserve every detail
    </div>
...
function tplNewsletterWelcome({ email = "" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-amber">🌸 You're subscribed!</span>
    ...
    <div class="info-box">
      ...
      🛍️ Flash sales and subscriber-exclusive offers<br />
...
function tplOtpVerification({ name = "User", otp = "------", purpose = "Verification" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-amber">🔐 ${purpose} OTP</span>
...
function tplPasswordReset({ name = "User", resetLink = "#" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-amber">🔑 Password Reset Request</span>
    <p class="greeting">Namaste ${name} 🙏</p>
...
function tplSellerApplicationReceived({ sellerName = "Applicant", businessName = "" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-blue">📋 Application Received</span>
...
function tplSellerApproved({ sellerName = "Artisan", businessName = "", dashboardLink = "https://kalavritti.in/seller" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-green">🎉 Application Approved!</span>
...
function tplPayoutSent({ sellerName = "Artisan", amount = 0, period = "", transactionId = "", bankAccount = "" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-green">💰 Payout Sent!</span>
    <p class="greeting">Namaste ${sellerName} 🙏</p>
...
function tplReviewRequest({ customerName = "Customer", orderId = "#KL-0000", productName = "your purchase" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-amber">⭐ Share Your Experience</span>
    <p class="greeting">Namaste ${customerName} 🙏</p>
...
function tplAbandonedCart({ customerName = "Customer", cartItems = [] as any[], cartTotal = 0 } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-amber">🛒 Items waiting for you!</span>
    <p class="greeting">Namaste ${customerName} 🙏</p>
...
function tplFlashSale({ title = "Flash Sale!", discount = "20", endsIn = "24 hours" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-red">⚡ Flash Sale — ${discount}% Off!</span>
...
function tplContactConfirmation({ name = "Guest", message = "" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-blue">📩 Message Received</span>
    <p class="greeting">Namaste ${name} 🙏</p>
...
function tplAdminNewSeller({ sellerName = "New Seller", businessName = "", mobile = "" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-blue">🔔 New Seller Application</span>
...
function tplAdminDailyReport({ date = "", totalRevenue = 0, totalOrders = 0, newCustomers = 0 } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-blue">📊 Daily Revenue Report</span>
...
function tplSecurityAlert({ alertType = "Unauthorized Access", ip = "", time = "", email = "" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-red">🚨 Security Alert</span>
    <p class="greeting">Admin Security Notice</p>
    <div class="alert-box alert-red">
      <strong>⚠️ ${alertType}</strong><br />
      ${ip ? `IP Address: ${ip}<br />` : ""}
...
function tplAccountSuspension({ name = "User", reason = "", reviewDate = "" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-red">🚫 Account Suspended</span>
    <p class="greeting">Namaste ${name} 🙏</p>
...
function tplReinstatement({ name = "User" } = {}) {
  return emailBase(`
  <div class="body">
    <span class="badge badge-green">✅ Account Reinstated</span>
