    ...
    <div className="min-h-screen bg-maroon-dark">
      ...
      <div className="relative w-full overflow-hidden" style={{ minHeight: "400px", maxHeight: "540px" }}>
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12 py-20 md:py-28 max-w-2xl">
          ...
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-cream font-semibold leading-[1.08] mb-5">
            Preserving the<br />
            <span style={{ color: "#D4860A" }}>Soul of Indian</span><br />
            Handicrafts
          </h1>
          <p className="text-cream/75 text-base max-w-md leading-relaxed">
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {PILLARS.map((pillar) => (
            <div key={pillar.title} className="bg-maroon/30 p-7 rounded-xl border border-maroon/50 text-center hover:border-gold/40 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 group">
              ...
              <h3 className="font-serif text-xl text-cream mb-2">{pillar.title}</h3>
              <p className="text-sm text-cream/65 leading-relaxed">{pillar.desc}</p>
            </div>
          ))}
        </div>
        ...
        <div className="relative w-full rounded-2xl overflow-hidden mb-20" style={{ minHeight: "280px" }}>
          ...
          <div className="relative z-10 px-8 md:px-14 py-12 md:py-16 max-w-xl">
            ...
            <h2 className="font-serif text-2xl md:text-3xl text-cream font-semibold mb-3 leading-snug">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <div key={item.label} className="flex items-center gap-2 bg-maroon/40 backdrop-blur-sm border border-gold/20 px-3 py-1.5 rounded-full">
        ...
        {/* Mission Quote */}
        <div className="bg-maroon p-12 md:p-16 rounded-2xl text-center relative overflow-hidden border-2 border-gold/30">
